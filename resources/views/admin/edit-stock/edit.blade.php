    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form" action="{{route('admin.edit-stock.edit',$item->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <?php
            ...
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="Please Enter Quantity" name="quantity" value="{{ $item->quantity }}">
                </div>
              </div>
            <!-- /.card-body -->
