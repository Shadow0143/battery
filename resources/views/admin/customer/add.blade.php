    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form"  action="{{route('admin.customer.add')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body row">
              ...
              <div class="form-group col-lg-6">
                ...
                <textarea name="address" class="form-control" rows="4" cols="30" placeholder="Please Enter Customer Address"></textarea>
              </div>
