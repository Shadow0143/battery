      ...
      <table class="table table-striped projects" id="pagi">
          ...
          <tbody>
            ...
            <?php if(!empty($results)){
              ...
              // dd(DB::getQueryLog());
                ...
                //    }
                   ...
                   $orderdtls = DB::table('order_details')
                              ->where('id',$item['id'])
                              ->orderBy('id', 'desc')
                              ->first();

                   $closingbalance = DB::table('order_stock_map')
            ...
            <?php $count++; } }else{ ?>
              ...
              <tr>
                <td colspan="8">
                    <div class="alert alert-danger" role="alert"> No Stock Exist on system, please add new </div>
                </td>
              </tr>
