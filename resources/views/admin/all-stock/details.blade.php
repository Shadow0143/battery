...
@endsection
@section('css')
<link rel="stylesheet" href="{{ \App\Http\Controllers\ExtraController::assetURL('custom/css/style.css') }}">
@endsection
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class=""><a href="{{route('admin.admin-dashboard')}}">Home &nbsp; -> &nbsp; </a></li>
          <li class=""><a href="{{route('admin.all-stock.view')}}">Stock Item &nbsp; -> &nbsp; </a></li>
          <li class="">Details</li>
        </ol>
      </div>
    </div>
