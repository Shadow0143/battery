...
<section class="content">
  <div class="card">
    <div class="card-header">
        <li>
        <form class="form-inline ml-6" action="{{route('employee.all-stock.search')}}" method="post">
            @csrf
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="text" name="search" value="{{$search}}" placeholder="Search" aria-label="Search">
          ...
          <tbody>
            ...
            if($items->isNotEmpty()):
              ...
              <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-sm" href="{{route('employee.all-stock.details',$item->id)}}">
